...
function handleBaking(recipe, pieType, pieQuantity) {
...
function handleSelling(costOfPie, pieQuantity, profitMargin) {
...
function bakeAndSellPies(pieType, pieQuantity, profitMargin) {
  ...
  handleBaking(recipe, pieType, pieQuantity);
  const costOfPie = handleCost(recipe);
  handleSelling(costOfPie, pieQuantity, profitMargin);
}
